...
public class UpdateShiftSchedulesValidation : AbstractValidator<UpdateShiftSchedulesCommand>
{
    public UpdateShiftSchedulesValidation()
    {
        RuleFor(x => x.ShiftScheduleId)
            .NotEmpty()
            .WithMessage("Shift schedule ID is required");
