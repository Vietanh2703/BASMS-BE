    ...
    public async Task<GetManagerByEmailResult> Handle(GetManagerByEmailQuery request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var managerDetailDto = new ManagerDetailDto(
                ...
                Role: manager.Role,
                CertificationLevel: manager.CertificationLevel,
                StandardWage: manager.StandardWage,
                CertificationFileUrl: manager.CertificationFileUrl,
                IdentityCardFrontUrl: manager.IdentityCardFrontUrl,
                IdentityCardBackUrl: manager.IdentityCardBackUrl,
