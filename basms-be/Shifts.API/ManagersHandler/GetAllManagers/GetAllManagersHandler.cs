        ...
        try
        {
            ...
            var managerDtos = managers
                ...
                .Select(m => new ManagerDto(
                    ...
                    StandardWage: m.StandardWage,
                    CertificationFileUrl: m.CertificationFileUrl,
                    IdentityCardFrontUrl: m.IdentityCardFrontUrl,
                    IdentityCardBackUrl: m.IdentityCardBackUrl,
