...
public class S3Service : IS3Service
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            // Tạo key cho file trong S3 (path/to/file.jpg)
    ...
    public string GetPresignedUrl(string fileUrlOrKey, int expirationMinutes = 15, string? downloadFileName = null)
    {
        try
        {
            ...
            else
            {
                ...
                // Format: attachment; filename="simple.jpg"; filename*=UTF-8''encoded%20name.jpg
    ...
    /// <summary>
    /// Sanitize filename to remove characters that might cause issues with HTTP headers
    /// </summary>
